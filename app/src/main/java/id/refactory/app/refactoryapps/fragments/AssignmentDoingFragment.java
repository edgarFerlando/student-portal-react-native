...
import id.refactory.app.refactoryapps.adapter.assignment.DoingAdapter;
 ...
 */
public class AssignmentDoingFragment extends Fragment {
    @Inject Retrofit retrofit;

    @BindView(R.id.assignment_numbers) RecyclerView recyclerView;
    @BindView(R.id.progressBarDoing) ProgressBar progressBar;
    ...
    public AssignmentDoingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_assignment_doing, container, false);
...
//                   Log.d("yeah", "onResponse: "+new Gson().toJson(result));
                    ...
                    for (DataAssignments data : assignments) {
                        if (data.getAssignmentType().toUpperCase().equals("PROJECT") && data.getStatus().toUpperCase().equals("DOING")) {
                            dataResults.add(data);
                        }
                    }

                    //this data loads
                    mAdapter = new DoingAdapter(dataResults, mFragmentListener); //assignments
